...
public class Cards
{
    public static void tarotCards(SLL<Card> firstPart,SLL<Card> secondPart)
    {
        ...
        // cekor 3 zemanje pretposledna karta od prv del
        SLLNode<Card> pretposlednaprvdel = firstPart.getFirst();
        while(pretposlednaprvdel != null){
            if(pretposlednaprvdel.succ != null){
                pom1 = pretposlednaprvdel;
            }
            pretposlednaprvdel = pretposlednaprvdel.succ;
        }

        // cekor 3 stavanje na sredina na vtoriot del
        int size;
        ...
        SLLNode<Card> sredinavtordel = secondPart.getFirst();
        for(int i = 0; i < size; i++){
            sredinavtordel = sredinavtordel.succ;
        }
        secondPart.insertBefore(pom1.element, sredinavtordel);
        firstPart.delete(pom1);
